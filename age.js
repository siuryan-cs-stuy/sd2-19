...
var avgAge = function(){
	...
	if(typeof a == "number"){
	    return a + (b["total"]*b['age']);
	}
	return a["total"]*a['age'];
    });
    return sum/totalPop();
}
...
var malesOnly = function(){
    var malelist = data.filter(function(x){
	return x["males"] > x["females"];
    });
    return malelist.map(function(x){
	return x["age"];
    });
}


var femalesOnly = function(){
    var femalelist = data.filter(function(x){
	return x["males"] < x["females"];
    });
    return femalelist.map(function(x){
	return x["age"];
    });

}

var total = document.getElementById("total_pop");
var avg = document.getElementById("avg_age");
var males = document.getElementById("males_greater");
var females = document.getElementById("females_greater");
...
total.innerHTML = totalPop() + " people";
avg.innerHTML = avgAge() + " years";
males.innerHTML = malesOnly();
females.innerHTML = femalesOnly();
